...
def _load_from_env() -> List[Dict[str, str]]:
    ...
    try:
        ...
        print("USERS_JSON mal formado, ignorando.")
    return []
...
def load_users() -> Tuple[List[Dict[str, str]], Dict[str, str]]:
    ...
    Devuelve (lista_de_usuarios, mapping_usuario->password)
...
def save_users(users_list: List[Dict[str, str]]) -> None:
    ...
    Solo tiene efecto cuando trabajas con archivo (no con USERS_JSON).
    """
