...
| Certificado TLS | `/etc/captive-portal/ssl/portal.{key,crt}` |
...
Es **normal** en portales cautivos con certificado autofirmado: el
navegador mostrará una advertencia que el usuario debe aceptar. Para
producción con dominio propio, considera Let's Encrypt/certbot.
